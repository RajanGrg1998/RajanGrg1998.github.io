...
const String kaMe = "$basePath$mePath/profilepic.png";
...
const String kaShowcaseStyle = "$basePath$mePath/profilepic.png";
const String kaCoffee = "$basePath$mePath/coffee.svg";

/// project images
const String projectPath = "/projects";
const String kaPulseX = "$basePath$projectPath/rebuzz.png";
const String kaThread = "$basePath$projectPath/rebuzz.png";
...
const String kaGraphQLCerti = "$basePath$certificatePath/react.jpg";
const String kaDeepLearningCerti = "$basePath$certificatePath/java.jpg";
const String kaPythonCerti = "$basePath$certificatePath/es6.jpg";
const String kaJSTCerti = "$basePath$certificatePath/ecosystems.jpg";
